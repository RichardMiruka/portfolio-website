  ...
  return (
    <div className="pb-20 pt-36">
        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className='max-w-[89vw] md:max-w-2xl lg:mx-w-[60vw] flex-col items-center justify-center'>
                ...
                <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl xl:text-3xl">
                      Hi, I am Richard Miruka, a Software Engineer specializing in Full Stack Development with a strong focus on Backend Engineering.
